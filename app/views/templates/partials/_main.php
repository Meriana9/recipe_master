<div class="container mx-auto flex flex-wrap pt-4 pb-12 text-gray-800">
    ...
    <main class="w-full md:w-3/4 p-3">
        ...
        <section class="relative mb-6">
            <img class="w-full h-96 object-cover" src="https://source.unsplash.com/1600x900/?recipe"
        ...
        <section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <article class="bg-white rounded-lg overflow-hidden shadow-lg relative">
                    <img class="w-full h-48 object-cover" src="https://source.unsplash.com/480x360/?recipe"
                        alt="Recipe Image" />
                    <div class="p-4">
